...
const CustomerRetail = ({ data }) => {

  const [customer, setCustomer] = useState({});

  useEffect(() => {
    (async () => {
      const customerData = await RequestUtils.Get(`/customer/find-by-phone?phone=${data?.mobile}&withOrder=withOrder`);
